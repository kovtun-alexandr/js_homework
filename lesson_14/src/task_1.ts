...
if (confirm('Почати тестування?')) {
     ...
     */
    function getTotalCoast(arr:Company[]):number {
     ...
     */
    function getMadeDuringPeriod(arr:Company[]):number {
     ...
     */
    function getAmountInvestment(arr:Company[]):number {
     ...
     */
    function getSponsors(arr:Company[]):any[] {
     ...
     */
    function getMaxCoast(arr:Company[]):number {
     ...
     */
    function getSortCompanies(arr:Company[]):Company[] {
        const deepCopy:Company[] = JSON.parse(JSON.stringify(arr))
     ...
     */
    function getSortingByCost(arr:Company[]) {
