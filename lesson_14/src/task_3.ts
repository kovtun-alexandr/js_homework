...
// 2) Товари, які доступні (sell_status:"available")
...
if (confirm('Почати тестування?')) {
     ...
     */
    function getTotalCoast(arr:Product[]):number {
     ...
     */
    function priceChanged(arr:Product[]) {
     ...
     */
    function getAvailableProducts(arr:Product[]):Product[] {
     ...
     */
    function getAvailableForSale(arr:Product[]):NewProduct[] {
    ...
    console.log(`Загальна вартість - ${getTotalCoast(dataList)}`)
    console.log(`Кількість товарів, у яких ціна зменшилась (price < old_price) -  ${priceChanged(dataList)}`)
    console.log('Товари, які доступні (sell_status:"available")')
    console.log(getAvailableProducts(dataList))
    console.log('Новий список об”єктів:')
